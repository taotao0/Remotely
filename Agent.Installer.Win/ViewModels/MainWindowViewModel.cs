using URemote.Agent.Installer.Win.Models;
using URemote.Agent.Installer.Win.Services;
...
namespace URemote.Agent.Installer.Win.ViewModels
{
...
private string _serverUrl = "https://remote.cookmung.com";
        ...
        public ICommand OpenLogsCommand
        {
            get
            {
                ...
                {
                    var logPath = Path.Combine(Path.GetTempPath(), "URemote_Installer.log");
        ...
        public async Task Init()
        {
            ...
            IsServiceInstalled = ServiceController.GetServices().Any(x => x.ServiceName == "URemote_Service");
            if (IsServiceMissing)
            {
        ...
        private bool CheckParams()
        {
                ...
                (serverUri.Scheme != Uri.UriSchemeHttp && serverUri.Scheme != Uri.UriSchemeHttps))
            {
                ...
                MessageBoxEx.Show("Server URL must be a valid Uri (e.g. https://remote.cookmung.com).", "Invalid Server URL", MessageBoxButton.OK, MessageBoxImage.Error);
                return false;
            }
        ...
        private BitmapImage GetBitmapImageIcon(BrandingInfo bi)
        {
            ...
            {
                imageStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("URemote.Agent.Installer.Win.Assets.URemote_Icon.png");
            }
        ...
        private async Task Install()
        {
            try
            {
                ...
                HeaderMessage = "Installing URemote...";
                ...
                if (await Installer.Install(ServerUrl, OrganizationID, DeviceGroup, DeviceAlias, DeviceUuid, CreateSupportShortcut))
                {
                    ...
                    StatusMessage = "URemote has been installed.  You can now close this window.";
                }
                else
                {
                    Progress = 0;
        ...
        private async Task Uninstall()
        {
            try
            {
                ...
                HeaderMessage = "Uninstalling URemote...";
                ...
                if (await Installer.Uninstall())
                {
                    ...
                    StatusMessage = "URemote has been uninstalled.  You can now close this window.";
                }
                else
                {
                    Progress = 0;
