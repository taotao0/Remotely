...
# Set permissions on URemote files.
...
echo "$nginxConfig" > /etc/nginx/sites-available/uremote

ln -s /etc/nginx/sites-available/uremote /etc/nginx/sites-enabled/uremote
